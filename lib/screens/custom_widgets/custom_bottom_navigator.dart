...
class CircleBottomNavigator extends StatelessWidget {
  final Function(int) onTap;
  final int currentIndex;
  final List<Widget> activeIcons;
  final List<Widget> inactiveIcons;
  const CircleBottomNavigator({Key? key, required this.onTap, required this.currentIndex,required this.activeIcons,required this.inactiveIcons,});
